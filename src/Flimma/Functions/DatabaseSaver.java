...
public final class DatabaseSaver {
    ...
    public void saveToFile(@NotNull Database database, @NotNull File file) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
            ...
            for (int i = 0; i < films.size(); i++) {
                ...
                for (String genre : film.getGenres()) {
                    writer.write("\"" + i + "\",\"" + film.getName() + "\",\"" + film.getPlot() + "\",\"" + genre + "\",\"" + film.getRelased() + "\",\"" + film.getImdbVotes() + "\",\"" + film.getImdbRating());
                    writer.newLine();
                }
            }
